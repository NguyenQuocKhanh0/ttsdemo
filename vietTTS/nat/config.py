...
class FLAGS(Namespace):
  ...
  # ckpt
  ckpt_dir_panh = Path('assets/panh')
  ckpt_dir_thao = Path('assets/thao')
  ckpt_dir_kien = Path('assets/kien')
  ckpt_dir_ltrang = Path('assets/ltrang')
  
  data_dir = Path('/content/drive/MyDrive/data/wavs')
